...
CLASS /awsex/cl_s3c_actions DEFINITION
  ...
  PUBLIC SECTION.
    ...
    METHODS update_job_priority
      ...
      RETURNING
        VALUE(ov_priority) TYPE /aws1/s3cjobpriority.
    ...
    METHODS update_job_status
      ...
      RETURNING
        VALUE(ov_status) TYPE /aws1/s3cjobstatus.
...
CLASS /awsex/cl_s3c_actions IMPLEMENTATION.
  ...
  METHOD update_job_priority.
    ...
    TRY.
        ...
        ov_priority = oo_result->get_priority( ).
        MESSAGE |Job { iv_job_id } priority updated to { ov_priority }| TYPE 'I'.
      CATCH /aws1/cx_s3cnotfoundexception INTO DATA(lo_nf).
        MESSAGE lo_nf->get_text( ) TYPE 'I'.
      CATCH /aws1/cx_s3cclientexc INTO DATA(lo_client_ex).
        MESSAGE lo_client_ex->get_text( ) TYPE 'I'.
  ...
  METHOD update_job_status.
    ...
    TRY.
        ...
        ov_status = oo_result->get_status( ).
        MESSAGE |Job { iv_job_id } status updated to { ov_status }| TYPE 'I'.
  ...
  METHOD put_job_tagging.
    ...
    TRY.
        ...
        MESSAGE |{ lines( it_tags ) } tag(s) applied to job { iv_job_id }| TYPE 'I'.
      CATCH /aws1/cx_s3cnotfoundexception INTO DATA(lo_nf).
        MESSAGE lo_nf->get_text( ) TYPE 'I'.
