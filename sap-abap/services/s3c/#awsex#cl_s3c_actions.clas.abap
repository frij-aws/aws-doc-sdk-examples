...
CLASS /awsex/cl_s3c_actions IMPLEMENTATION.
  ...
  METHOD create_job.
    ...
    " Build the manifest fields list (Bucket and Key columns)
    ...
    " Build the operation: tag each object with a BatchTag
        ...
        DATA(lo_result) = lo_s3c->createjob(
          ...
          io_manifest           = NEW /aws1/cl_s3cjobmanifest(
            io_spec     = NEW /aws1/cl_s3cjobmanifestspec(
              " e.g. 'S3BatchOperations_CSV_20180820'
          ...
          io_report             = NEW /aws1/cl_s3cjobreport(
            " e.g. 'arn:aws:s3:::my-report-bucket'
  ...
  METHOD update_job_status.
    ...
    TRY.
      ...
      CATCH /aws1/cx_s3cnotfoundexception INTO DATA(lo_nf_ex).
        MESSAGE lo_nf_ex->get_text( ) TYPE 'I'.
      CATCH /aws1/cx_s3cclientexc INTO DATA(lo_client_ex).
        MESSAGE lo_client_ex->get_text( ) TYPE 'I'.
      CATCH /aws1/cx_s3cserverexc INTO DATA(lo_server_ex).
        MESSAGE lo_server_ex->get_text( ) TYPE 'I'.
  ...
  METHOD get_job_tagging.
    ...
    TRY.
        DATA(lo_result) = lo_s3c->getjobtagging(
          iv_accountid = iv_account_id
          iv_jobid     = iv_job_id ).
  ...
  METHOD put_job_tagging.
    ...
    TRY.
      ...
      CATCH /aws1/cx_s3ctoomanytagsex INTO DATA(lo_ex).
        MESSAGE lo_ex->get_text( ) TYPE 'I'.
      CATCH /aws1/cx_s3cnotfoundexception INTO DATA(lo_nf_ex).
        MESSAGE lo_nf_ex->get_text( ) TYPE 'I'.
      CATCH /aws1/cx_s3cclientexc INTO DATA(lo_client_ex).
  ...
  METHOD list_jobs.
    ...
    TRY.
        DATA(lo_result) = lo_s3c->listjobs(
          iv_accountid   = iv_account_id
