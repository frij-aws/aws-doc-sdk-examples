...
CLASS /awsex/cl_se2_actions IMPLEMENTATION.
  ...
  METHOD get_email_identity.
    ...
    TRY.
        ...
        MESSAGE |Email identity { iv_email_identity }: type { oo_result->get_identitytype( ) }, | &&
                |verification status { oo_result->get_verificationstatus( ) }| TYPE 'I'.
      CATCH /aws1/cx_se2notfoundexception INTO DATA(lo_not_found).
  ...
  METHOD send_bulk_email.
    ...
    TRY.
        " Build one bulk entry per recipient address.
        ...
        " Build default content using the named template.
        ...
        MESSAGE |Bulk email sent: { lv_count } result(s) returned for template { iv_template_name }| TYPE 'I'.
