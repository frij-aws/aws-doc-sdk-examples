...
CLASS /AWSEX/CL_FNT_ACTIONS IMPLEMENTATION.
  ...
  METHOD list_distributions.
    ...
    TRY.
        " list_distributions returns the first page of results.
        " For accounts with many distributions, check
        " get_distributionlist( )->get_istruncated( ) and call
        " list_distributions again with iv_marker set to
        " get_distributionlist( )->get_nextmarker( ) to retrieve
        " subsequent pages.
  ...
  METHOD update_distribution.
    ...
    TRY.
        ...
        MESSAGE |Distribution { iv_distribution_id } updated;| &&
                | new ETag: { oo_result->get_etag( ) }| TYPE 'I'.
      ...
      CATCH /aws1/cx_fntaccessdenied INTO DATA(lo_access_ex).
        MESSAGE lo_access_ex->get_text( ) TYPE 'I'.
      CATCH /aws1/cx_fntinvalidifmatchvrs INTO DATA(lo_etag_ex).
        MESSAGE lo_etag_ex->get_text( ) TYPE 'I'.
